  ...
  const differentials = [
    {
      ...
      description:
        'Todos os nossos equipamentos passam por rigorosa manutenção preventiva e nossos operadores são certificados e treinados regularmente.',
    },
    {
      icon: Clock,
      title: 'Agilidade na Entrega',
      description:
        'Frota própria e equipe dedicada garantem entregas rápidas e flexibilidade para atender prazos apertados de sua obra.',
    },
    {
      icon: Heart,
      title: 'Confiabilidade Comprovada',
      description:
        '25 anos no mercado construindo relacionamentos sólidos com nossos clientes através de serviços de qualidade e transparência.',
    },
  ];
      ...
      <div className="container mx-auto px-4">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div>
            ...
            <div className="space-y-6 font-body text-lg text-muted-foreground">
              <p>
                Fundada em 1999, a{' '}
                <strong className="text-foreground">SM Locação de Máquinas</strong> nasceu da visão
                de oferecer soluções completas em movimentação de cargas pesadas para o setor
              ...
              <p>
                Nossa equipe especializada e frota moderna garantem que cada projeto seja executado
                com excelência, desde pequenas movimentações até grandes operações industriais.
              </p>
            </div>
        ...
        <div className="mt-20 text-center">
          <div className="bg-primary/5 rounded-3xl p-12 border border-primary/10">
            <h3 className="font-heading font-bold text-3xl text-foreground mb-6">Nossa Missão</h3>
            <p className="font-body text-xl text-muted-foreground max-w-4xl mx-auto leading-relaxed">
              ...
              <strong className="text-primary"> agilidade</strong>, contribuindo para o sucesso de
              seus projetos e o desenvolvimento da indústria brasileira.
            </p>
